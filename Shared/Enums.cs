...
public enum WeatherSetting : ushort
{
    ...
    红色余烬 = 2, // RedEmber = 2,
    白色余烬 = 4, // WhiteEmber = 4,
    黄色余烬 = 8, // YellowEmber = 8,
    火焰粒子 = 16, // FireParticle = 16, 落雪
    飘雪 = 32, // Snow = 32,
    雨天 = 64, // Rain = 64,
    黄色花瓣 = 128, // Leaves = 128,
...
public enum IntelligentCreatureType : byte
{
    ...
    青蛙 = 10, // Frog = 10,
    红猴 = 11, // BabyMonkey = 11,
    愤怒的小鸟 = 12, // AngryBird = 12,
    阿福 = 13, // Foxey = 13,
    治疗拉拉 = 14, // MedicalRat = 14,
    // 猫咪超人 = 15,
    // 龙宝宝 = 16,
    // 蛇宝宝 = 17,
}
...
public enum Spell : byte
{
    ...
    FlashDash = 103, // 拔刀术
    LightBody = 104, // 风身术
    HeavenlySword = 105, // 迁移剑
    FireBurst = 106, // 烈风击
    Trap = 107, // 捕缚术
    PoisonSword = 108, // 猛毒剑气
    MoonLight = 109, // 月影术
    MPEater = 110, // 吸气
    SwiftFeet = 111, // 轻身步
    DarkBody = 112, // 烈火身
    Hemorrhage = 113, // 血风击
    CrescentSlash = 114, // 月华乱舞
    MoonMist = 115, // 月影雾
    CatTongue = 116, // 猫舌兰

    //Archer
    Focus = 121, // 必中闪
    StraightShot = 122, // 天日闪
    DoubleShot = 123, // 无我闪
    ...
    BindingShot = 131, // 困兽笼
    Stonetrap = 132, // 地柱钉
    SummonVampire = 133, // 吸血地精
    VampireShot = 134, // 吸血地闪
    SummonToad = 135, // 痹魔阱
    PoisonShot = 136, // 毒魔闪
    CrippleShot = 137, // 邪爆闪
