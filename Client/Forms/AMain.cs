...
namespace Launcher
{
    public partial class AMain : Form
    {
        ...
        private void AMain_Load(object sender, EventArgs e)
        {
            ...
            Version_label.Text = GameLanguage.ClientTextMap.GetLocalization((ClientTextKeys.BuildVersionLabel), Globals.ProductCodename, Settings.UseTestConfig ? "Debug" : "Release", Application.ProductVersion);
